<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark shadow">
    <a class="navbar-brand" href="{{ route('admin.dashboard') }}">Friday Maxx</a>
    ...
    <ul class=" d-none d-md-block my-2  mx-auto">
            ...
            <a class="btn btn-outline-light btn-sm " href=""> Subscription </a>
    ...
    @auth
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="{{ route('register.index') }}">Friday Maxx</a>
